<<<<<<< HEAD:ClassAttendanceManager/ClassAttendanceManager.py
import json
import time
...
class AttendanceList(object):
    ...
    def change_total_weeks(self):
        ...
        print("Total weeks changed to {0}".format(new_total_weeks))
    ...
    def reset(self):
        ...
        if confirm == "CONFIRM":
            ...
            for i in range(21):
                ...
                s = " " * (20 - i)
                l = round((100 / 21) * (i + 1))
                print("[{0}{1}] - {2}%".format(p, s, l), end="\r")
                time.sleep(0.3)
        ...
        while not valid_week:
            ...
            try:
                ...
                if 0 < week_number <= self.total_weeks:
                    ...
                    print("Week number should be between 0 and {0}".format(self.total_weeks + 1))
            except:
                print("Week NUMBER!")
...
def main():
    attendance_obj = AttendanceManager()
    attendance_obj.start()


if __name__ == "__main__":
    main()
>>>>>>> aa1bf7769d6508b418e2160a3dd555faf32d1b37:ClassAttendanceManager.py
